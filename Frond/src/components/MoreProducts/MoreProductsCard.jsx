...
const MoreProductsCard = ({name, precio_venta }) => {
  ...
  return (
    ...
    <img className="rounded-lg w-full m-auto shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]" src="https://i.ibb.co/ctpR3L1/img158.jpg" alt="a" />
