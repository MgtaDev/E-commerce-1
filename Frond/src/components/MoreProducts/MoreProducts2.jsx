...
const MoreProductsCardContainer2 = () => {
  ...
  className="absolute z-30 left-0 ml-4 sm:ml-8 focus:outline-none focus:bg-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 rounded-full bg-gray-100 hover:bg-gray-200 p-3"
  id="back"
>
  <svg
    width={8}
  ...
  className="absolute z-30 right-0 mr-4 sm:mr-8 focus:outline-none focus:bg-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 rounded-full bg-gray-100 hover:bg-gray-200 p-3"
  id="next"
>
  <svg
    width={8}
