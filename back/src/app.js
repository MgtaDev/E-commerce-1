...
server.post("/pagoCarrito", (req, res) => {
  ...
  let preference = {
    ...
    back_urls: {
      ...
      // pending: "",
      // "bonitaandlovely-git-developer-brandonlopez98.vercel.app",
      success: "bonitaandlovely-git-developer-brandonlopez98.vercel.app",
      failure: "bonitaandlovely-git-developer-brandonlopez98.vercel.app",
      pending: "",
    },
...
server.post("/pago", (req, res) => {
  ...
  let preference = {
    ...
    back_urls: {
      // "bonitaandlovely-git-developer-brandonlopez98.vercel.app//catalogo",
      success: "bonitaandlovely-git-developer-brandonlopez98.vercel.app/catalogo",
      failure: "bonitaandlovely-git-developer-brandonlopez98.vercel.app",
      pending: "",
    },
    auto_return: "approved",
